...
for link in links:
  ...
  player_rows = []
  player_rows.insert(0, roster_table.find_element_by_tag_name('tbody').find_elements_by_tag_name('tr')[0])
  ...
  data_frame.to_csv('/Users/Chris/Documents/csv-files/' + team_abrv + '.csv')
